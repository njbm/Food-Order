                        ...
                        <div class="head-container">
                            <div class="header-top-inner">
                                <div class="header-top-left">
                                    <a href="#" class="top-cell"><img src="{{ asset('assets/frontend/') }}./img/icon/fon.png" alt="Image not Found"> <span>+1234567890</span></a>
                                ...
                                <div class="left-menu">
                                    ...
                                    <div class="menu-main">
                                        <ul>
                                            ...
                                            <li class="mega-menu"><a href="{{route('home')}}">Menu</a></li>
                                            <li class="has-child"><a href="{{route('home')}}">Shop</a></li>
                                ...
                                <ul class="category-list-m">
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category-11.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category3.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category-22.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category-33.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category-44.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category-55.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                                    ...
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category5.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                                        <a href="" class="category-link">
                                            <div class="cat-img"><img src="{{ asset('assets/frontend/') }}./img/category/category7.png" alt=""></div>
                                            <span class="cat-name-m">BBQ Category</span>
                                        </a>
                                    </li>
                                    <li class="category-list-m">
                    ...
                    <div class="slider-bg">
                        <div class="slider-item">
                            <div class="image">
                                ...
                                <img src="{{ asset('assets/frontend/') }}./img/baner/banner.jpg" alt="Image not Found" class="img-fluid">
                            </div>
                            <div class="love-icon">
                                <!-- Place your small background image here-->
                                <img src="{{ asset('assets/frontend/') }}./img/icon/banner_image_1.png" class="love-1 object img-fluid" data-value="5" alt="Image not Found">
                                <img src="{{ asset('assets/frontend/') }}./img/icon/banner_image_3.png" class="love-3 object img-fluid" data-value="-3" alt="Image not Found">
                                <img src="{{ asset('assets/frontend/') }}./img/icon/welcome_image.png" class="love-2 object img-fluid" data-value="-8" alt="Image not Found">
                            </div>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 ban-food-img">
                                                ...
                                                <img src="{{ asset('assets/frontend/') }}./img/baner/h1_pizza.png" class="main-img object img-fluid" data-value="4" alt="Image not Found">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="baner-slider owl-carousel owl-theme">
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            ...
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category-11.png " alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>Combo</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category-22.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>kids menus</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category-33.png " alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>pizza</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category-44.png " alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>box meals</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category-55.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>burger</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category3.png " alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>chicken</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item ">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category5.png " alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>sauces</p>
                                            </div>
                                        </a>
                                ...
                                <div class="item">
                                    <div class="cat-item-inner ">
                                        <a href="" class="cat-link ">
                                            <!-- Please your category image here -->
                                            <img src="{{ asset('assets/frontend/') }}./img/category/category7.png" alt="Image not Found" class="category-img img-fluid">
                                            <div class="cat-name">
                                                <p>Drinks</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 my-2">
                                        <div class="baner">
                                            ...
                                            <div class="banar-image">
                                                ...
                                                <img src="{{ asset('assets/frontend/') }}./img/product/gallery_image1-min-1-768x768.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-6 my-2">
                                        <div class="baner">
                                            ...
                                            <div class="banar-image">
                                                <!-- Banar image are insert here -->
                                                <img src="{{ asset('assets/frontend/') }}./img/product/gallery_image5-min-768x768.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-6 my-2">
                                        <div class="baner">
                                            ...
                                            <div class="banar-image">
                                                <!-- Banar image are insert here -->
                                                <img src="{{ asset('assets/frontend/') }}./img/product/gallery_image2-min-1-768x768.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="container-fluid custom-padding">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="sm-baner">
                                        <a href="">
                                            <img src="{{ asset('assets/frontend/') }}./img/baner/slice-crispy-pizza-with-meat-cheese.jpg" alt="Baner Image not Found" class="sm-baner-image">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="paralex">
                                        <img src="{{ asset('assets/frontend/') }}./img/icon/banner_image_2.png" alt="" class="icon-plx" id="top-recipes-top">
                                        <img src="{{ asset('assets/frontend/') }}./img/icon/—Pngtree—fast food chicken drumstick fried_5746705.png" alt="" class="icon-plx-2" id="top-recipes-left">
                                    </div>
                                    <div class="top-recipes-inner">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6 col-12">
                                                <div class="product-list-inner">
                                                    <div class="recipes-image">
                                                        <img src="{{ asset('assets/frontend/') }}./img/product/img57.png" alt="">
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-12">
                                                <div class="product-list-inner">
                                                    <div class="recipes-image">
                                                        <img src="{{ asset('assets/frontend/') }}./img/product/img63.png" alt="">
                                                    </div>
                                                    <div class="recipes-details">
                                                        <a href="">
                                                            <h5>Bacon Burger</h5>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-12">
                                                <div class="product-list-inner">
                                                    <div class="recipes-image">
                                                        <img src="{{ asset('assets/frontend/') }}./img/product/meat-2.png" alt="">
                                                    </div>
                                                    <div class="recipes-details">
                                                        <a href="">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-12">
                                                <div class="product-list-inner">
                                                    <div class="recipes-image">
                                                        <img src="{{ asset('assets/frontend/') }}./img/product/pizza_1.png" alt="">
                                                    </div>
                                                    <div class="recipes-details">
                                                        <a href="">
                                                            <h5>BBQ Chicken Breast</h5>
                        ...
                        <div class="discount-inner">
                            <div class="row">
                                ...
                                <div class="col-md-6 discount-img-sec">
                                    <img src="{{ asset('assets/frontend/') }}./img/product/barger.png" alt="" class="discount-img">
                                </div>
                            </div>
                        </div>
                        <!-- discount inner end -->
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-4 col-sm-6 mb-3">
                                            <div class="product-jearny-bg">
                                                <img src="{{ asset('assets/frontend/') }}./img/icon/pizza.svg" alt="">
                                        ...
                                        <div class="col-md-4 col-sm-6 mb-3">
                                            <div class="product-jearny-bg">
                                                <img src="{{ asset('assets/frontend/') }}./img/icon/burger.svg" alt="">
                                                <div class="jearny-cotent">
                                                    <div class="">
                                                        <h2>180+</h2>
                                        ...
                                        <div class="col-md-4 col-sm-6 mb-3">
                                            <div class="product-jearny-bg">
                                                <img src="{{ asset('assets/frontend/') }}./img/icon/drink.svg" alt="">
                                                <div class="jearny-cotent">
                                                    <div class="">
                                                        <h2>250+</h2>
                            ...
                            <div class="chefc-slider owl-carousel owl-theme">
                                <div class="item">
                                    <div class="chefc-card ">
                                        <div class="chefc-img-div" data-bs-toggle="modal" data-bs-target="#chefc">
                                            <div class="img-view">
                                                <img src="{{ asset('assets/frontend/') }}./img/chefc/chefc-1.jpg" alt="" class="chefc-img">
                                            </div>
                                            <div class="view-info">
                                                <p>View Details</p>
                                            </div>
                                ...
                                <div class="item">
                                    <div class="chefc-card ">
                                        <div class="chefc-img-div" data-bs-toggle="modal" data-bs-target="#chefc">
                                            <div class="img-view">
                                                <img src="{{ asset('assets/frontend/') }}./img/chefc/2 (1).jpg" alt="" class="chefc-img">
                                            </div>
                                            <div class="view-info">
                                                <p>View Details</p>
                                            </div>
                                ...
                                <div class="item">
                                    <div class="chefc-card ">
                                        <div class="chefc-img-div" data-bs-toggle="modal" data-bs-target="#chefc">
                                            <div class="img-view">
                                                <img src="{{ asset('assets/frontend/') }}./img/chefc/1 (1).jpg" alt="" class="chefc-img">
                                            </div>
                                            <div class="view-info">
                                                <p>View Details</p>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 my-2">
                                                        <div class="chegc-image">
                                                            <img src="{{ asset('assets/frontend/') }}./img/chefc/1.jpg" alt="Image not found">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 my-2">
                                                    ...
                                                    <div class="details">
                                                        <div class="avatar">
                                                            <div class="elementor-testimonial-image">
                                                                <img src="{{ asset('assets/frontend/') }}./img/user/avatar-1.jpg" class="attachment-full size-full lazyloaded" alt="">
                                            ...
                                            <div class="item-box">
                                                <div class="top">
                                                    <div class="details">
                                                        <div class="avatar">
                                                            <div class="elementor-testimonial-image">
                                                                <img src="{{ asset('assets/frontend/') }}./img/user/avatar-2.jpg" class="attachment-full size-full lazyloaded" alt="">
                                                                <i aria-hidden="true" class="fas fa-quote-left"></i></div>
                                                        </div>
                                                        <div class="info">
                                            ...
                                            <div class="item-box">
                                                <div class="top">
                                                    <div class="details">
                                                        <div class="avatar">
                                                            <div class="elementor-testimonial-image">
                                                                <img src="{{ asset('assets/frontend/') }}./img/user/avatar-3.jpg" class="attachment-full size-full lazyloaded" alt="">
                                                                <i aria-hidden="true" class="fas fa-quote-left"></i></div>
                                                        </div>
                                                        <div class="info">
                                            ...
                                            <div class="item-box">
                                                <div class="top">
                                                    <div class="details">
                                                        <div class="avatar">
                                                            <div class="elementor-testimonial-image">
                                                                <img src="{{ asset('assets/frontend/') }}./img/user/avatar-4.jpg" class="attachment-full size-full lazyloaded" alt="">
                                                                <i aria-hidden="true" class="fas fa-quote-left"></i></div>
                                                        </div>
                                                        <div class="info">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="footer_logo">
                                        <a href="index.html">
                                             <img alt="logo" src="img/logo.png" style="height:30px; width: 130px;"></a>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-4">
                                    ...
                                    <ul class="list_none instafeed">
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta_img2.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta_img3.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta_img4.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta_img5.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta_img6.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta_img7.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('assets/frontend/') }}./img/blog/insta_img8.jpg" alt="insta_img"><span class="insta_icon"><i class="fab fa-instagram"></i></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-4 order-lg-first">
                                        <ul class="list_none footer_payment text-center text-lg-left">
                                            <li>
                                                <a href="#"><img src="{{ asset('assets/frontend/') }}./img/icon/visa.png" alt="visa"></a>
                                            </li>
                                            <li>
                                                <a href="#"><img src="{{ asset('assets/frontend/') }}./img/icon//discover.png" alt="discover"></a>
                                            </li>
                                            <li>
                                                <a href="#"><img src="{{ asset('assets/frontend/') }}./img/icon//master_card.png" alt="master_card"></a>
                                            </li>
                                            <li>
                                                <a href="#"><img src="{{ asset('assets/frontend/') }}./img/icon//paypal.png" alt="paypal"></a>
                                            </li>
                                            <li>
                                                <a href="#"><img src="{{ asset('assets/frontend/') }}./img/icon//amarican_express.png" alt="amarican_express"></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-4">
