          ...
          <div class="bg-purple rounded overflow-hidden">
            <div class="pd-x-20 pd-t-20 d-flex align-items-center">
              ...
              <div class="mg-l-20">
                ...
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">$0</p>
                <span class="tx-11 tx-roboto tx-white-8">$0 before tax</span>
              </div>
            </div>
          ...
          <div class="bg-teal rounded overflow-hidden">
            <div class="pd-x-20 pd-t-20 d-flex align-items-center">
              ...
              <div class="mg-l-20">
                ...
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">0%</p>
                <span class="tx-11 tx-roboto tx-white-8">0% average duration</span>
              </div>
            </div>
          ...
          <div class="bg-primary rounded overflow-hidden">
            <div class="pd-x-20 pd-t-20 d-flex align-items-center">
              ...
              <div class="mg-l-20">
                ...
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">0%</p>
                <span class="tx-11 tx-roboto tx-white-8">0% on average time</span>
              </div>
            </div>
